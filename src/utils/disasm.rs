...
fn get_referenced_registers(mnemonic: Mnemonic, instr: Instruction) -> ReferencedRegisters {
    match mnemonic {
        ...
        Mnemonic::MFHI => ReferencedRegisters::None,
        Mnemonic::MFLO => ReferencedRegisters::None,
        Mnemonic::MTCz => ReferencedRegisters::None,
        Mnemonic::MTHI => ReferencedRegisters::None,
        Mnemonic::MTLO => ReferencedRegisters::None,
